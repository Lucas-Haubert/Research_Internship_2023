...
class CleanData:
    ...
    # Building the CleanData objects, extracted from the clean Excel tables
    ...
    # Getting information about the required column of the clean Excel table
...
# Extracting the clean Excel tables that represent assets/index AAPL, AMZN, DJIA and BTC
aaplData=CleanData("C:/Users/Utilisateur/Documents/Mirror/Études/ICM_2A/Stage 2A/UiO/3. Le stage/3. Mon travail/0. Filled data/aaplData.csv")
amznData=CleanData("C:/Users/Utilisateur/Documents/Mirror/Études/ICM_2A/Stage 2A/UiO/3. Le stage/3. Mon travail/0. Filled data/amznData.csv")
djiaData=CleanData("C:/Users/Utilisateur/Documents/Mirror/Études/ICM_2A/Stage 2A/UiO/3. Le stage/3. Mon travail/0. Filled data/djiaData.csv")
btcData =CleanData("C:/Users/Utilisateur/Documents/Mirror/Études/ICM_2A/Stage 2A/UiO/3. Le stage/3. Mon travail/0. Filled data/btcData.csv")

# Getting the underlaying dataframe given its symbol
def getData(symbol):
...
# Plotting dates from cut values to figure out the uniformity of the distribution of
# cut values, ie to study the link betweeen real time line and dataframe time lines 
